<%-- 
    Document   : ViewAdvancedSalRequestDetails
    Created on : Nov 25, 2010, 5:52:34 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: View Advanced Salary Request</title>
        ...
        <script type="text/javascript">
            ...
            function adSalApprove(form,idval1)
            {
                alert("  id "+idval1);
                window.location.href="ApproveAdSalary.do?method=approveAdvancedSalaryRequest&hiddenId="+idval1;
                //form.method.value="approveLeaveRequest";
                alert("***************");
                form.submit();
            }
            function adSalReject(form,idval2)
            {
                window.location.href="RejectAdSalary.do?method=rejectAdvancedSalaryRequest&hiddenId="+idval2;
                alert("****************");
                form.submit();
            }
                                                                ...
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Total Salary  </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Advanced Amount </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">No. Of Installment</td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Deduction Start month</td>
                                                                        ...
                                                                        <logic:present name="empList" scope="request">
                                                                            <logic:iterate id="itr" name="empList" indexId="no">
                                                                                <html:form action="ViewAdvancedSalaryRequestDetails">

                                                                                    <tr bgcolor="<c:if test="${no%2!=0}" >cornsilk</c:if><c:if test="${no%2==0}" >white</c:if>" align="center">
                                                                                        <td>
                                                                                            <bean:write name="itr" property="id"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="empId"></bean:write>
                                                                                            <br/><a href="#" onclick="return openWindow(<bean:write name='itr' property='empId'/>);" >View Employee Details</a>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="totalSal"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="reqAmt"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="installment"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="deductstartmonth"></bean:write>
                                                                                        </td>
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="button" value="Approve" onclick="adSalApprove(this.form,<bean:write name='itr' property='id'/>)"/>
                                                                                            ...
                                                                                            <div style="margin-top:5px;">
                                                                                                ...
                                                                                                <div style="margin-top:5px; display:none;">
                                                                                                    <table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <input type="button" value="Submit" onclick="adSalReject(this.form,<bean:write name='itr' property='id'/>)"/>
