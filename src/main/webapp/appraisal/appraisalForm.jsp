                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="3" cellpadding="0">
                                                                                    <tr>
                                                                                        <td valign="middle"><b>Appraisal For:
                                                                                                <logic:present name="appraiseeInfo" scope="session">
                                                                                                    <logic:iterate id="itr" name="appraiseeInfo" indexId="no">
                                                                                        ...
                                                                                        <td valign="middle"><a href="getAttendanceReport.do?method=getAttendance"  onclick="NewWindow(this.href,'name','450','700','yes');return false"><img src="../images/report.gif" style="border-style:none"/>Attendance</a></td>
                                                                                        <td valign="middle"><a href="getReport.do?method=getAppraisalReport"  onclick="NewWindow(this.href,'name','500','300','yes');return false"><img src="../images/report.gif" style="border-style:none"/>Appraisal</a></td>
                                                                                                <%--
                                                                                                                        ...
                                                                                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="middle">
                                                                                                                                    ...
                                                                                                                                    <form action="appraise1.do" method="post"  class="form" id="form1">
                                                                                                                                        <%int i = 2;%>
                                                                                                                                        <logic:present name="setup" scope="request">
                                                                                                                                            <logic:iterate id="itr" name="setup" indexId="no">
                                                                                                                                                    ...
                                                                                                                                                    <table width="100%" border="0" align="left" cellpadding="2" cellspacing="2">
                                                                                                                                                        ...
                                                                                                                                                        <tr>
                                                                                                                                                            <td><table width="60%" border="0" align="center" cellpadding="4" cellspacing="4">
                                                                                                                                                                    <tr>
                                                                                                                                                                        <td align="center" valign="middle">
                                                                                                                                                                            <input type="hidden" name="method" value="saveAppraisalMarks" />
