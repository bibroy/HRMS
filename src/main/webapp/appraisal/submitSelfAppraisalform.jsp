...
<html:html>
    <head>
        ...
        <title>HRMS :: submit appraisal form</title>
 ...
 <script type="text/javascript">
      function calculatesummary(form){
          form.method.value="selfcalculateMarks";
          form.submit();
      }
     </script>
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                            ...
                                                                            <h1 >  successfully appraised....</h1>
                                                                            <p> you will be inform soon about another appraisal.</p>
                                                                    </td></tr></table>
                                                                         <html:form action="appraisalcalculation" method="post">
                                                                             <table>
                                                                                <tr>
                                                                                    <td> <html:button property="button" value="calculate score"  onclick="return calculatesummary(this.form)" /></td>
