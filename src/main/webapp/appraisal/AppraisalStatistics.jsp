...
<html:html>
    <head>
        ...
        <script type="text/javascript">
            function load(form)
            {
                form.method.value="getAppraisalReportByCategory";
                form.submit();
            }
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="/appraisalpiechart.do">
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  align="left" valign="middle">
                                                                        <html:select onchange="load(this.form);" property="employee_code">
                                                                            <html:option value="">--Select Please--</html:option>
                                                                            <logic:present name="employee" scope="request">
                                                                                <html:options name="employee" />
                                                                            </logic:present>
                                                                        </html:select>
                                                                    </td>
                                                                </tr>
