<%-- 
    Document   : RecruitedCandidateReport
    Created on : Dec 13, 2010, 3:28:22 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: Recruited Candidates</title>
                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <display:table export="true" class="dataTable"  name="requestScope.Candidates" style="cellpadding:5; width=600px;" sort="list"  requestURI="recruitmentreport.do?method=getSelectedCandidates"  pagesize="10"  >

                                                                        <display:column property="id" title="CId" sortable="true" />
                                                                        ...
                                                                        <display:caption style="color:red; font-size:25px;">Selected Candidates</display:caption>
