...
<html:html>
    <head>
        ...
        <title>HRMS ::Edit agencies</title>
        ...
        <script type="text/javascript">
            ...
            function editAgencies(form)
            {
                form.method.value="getAgencyInfo";
            ...
            function view(form) {
                ...
                //alert(linkPage);
                window.open (linkPage,'PopUp','left=300,top=200,toolbar=no, menubar=yes, scrollbars=yes, resizable=yes,location=no, directories=no, status=no,width=697,height=277');
                                                                    ...
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            ...
                                                                            <table width="80%" border="0" cellspacing="10" cellpadding="2">
                                                                                ...
                                                                                <tr>
                                                                                    <td> <html:button property="button" value="edit"  onclick="return editAgencies(this.form)" /></td>
