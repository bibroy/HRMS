<%-- 
    Document   : RecruitmentMarksEntry
    Created on : Dec 11, 2010, 6:25:50 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <html:base/>
    <head>
        <title>HRMS :: Recruitment Marks Entry</title>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function increamentTxtBox(id){
                ...
                //alert(id);
                var id2=id+1;
                document.getElementById(id).innerHTML='<table  border="1" cellpadding="0" cellspacing="0" bgcolor="cornsilk" > <tr><td><input type="text" name="examName"/></td><td><input type="text" name="maxMarks"/></td><td><input type="text" name="marksObt"/></td><td><input type="text" name="examDate"/><img onclick="javascript:popUpCalendar(this,document.forms[0].examDate['+(id-1)+'],\'dd/mm/yyyy\')" src="../images/tlsCalendarIcon.gif" /></td></tr></table><br></div><div id="'+id2+'"></div>';
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <form action="../addrecruitmarks.do" method="post">
                                                            <table align="left" bgcolor="ghostwhite" width="200" width="1000">
                                                                <tr align="center" bgcolor="goldenrod">
                                                                    <td colspan="5"><font color="white"><b>Enter Candidate's Marks</b></font></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                                                                        <div id="1">
                                                                            <table  border="1" cellpadding="0" cellspacing="0" bgcolor="cornsilk" >
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><input type="text" name="marksObt"</td>
                                                                                    <td><input type="text" name="examDate"/><html:img onclick="javascript:popUpCalendar(this,document.forms[0].examDate,'dd/mm/yyyy')" src="../images/tlsCalendarIcon.gif" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <br>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <table align="center">
                                                                            <tr>
                                                                                ...
                                                                                <td> <input type="hidden" name="method" value="saveMarks" />
