<%-- 
    Document   : JobTransferReport
    Created on : Feb 27, 2011, 1:10:39 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: Job Transfer Report</title>
        ...
        <script type="text/javascript">
            function sub(form)
            {
                form.method.value="genJobTransferReport";
                form.submit();
            }
        </script>
    </head>
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    <html:form action="relocateEmployee.do">
                                                                        <html:button property="button" value="Generate Report" onclick="sub(this.form);"/>
