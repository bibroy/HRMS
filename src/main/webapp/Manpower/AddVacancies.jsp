<%-- 
    Document   : AddVacancies
    Created on : Feb 25, 2011, 11:38:07 AM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: Add Vacancies</title>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="saveVacancyInfo";
                ...
                if(!checkBlank(form.skillreq,'Required Skills'))
                {
                    return;
                }
                if(!checkBlank(form.quali, 'Highest Qualification'))
                {
                    return;
                }
                if(!checkBlank(form.noofvac, 'No of Vacancies'))
                {
                    return;
                }
                if(!checkBlank(form.lastDate,'Last Date'))
                {
                    return;
                }
                if(!checkBlank(form.experience,'Experience'))
                {
                    return;
                }
                if(!checkNum(form.noofvac,'No of Vacancies'))
                {
                    return;
                }
                 if(!checkChar(form.quali,'Highest Qualification'))
                {
                    return;
                }
                 if(!checkChar(form.post,'Post'))
                {
                 ...
                 if(!checkChar(form.skillreq,'Required Skills'))
                {
                    return;
                }
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="addVacancy.do" >
                                                                    ...
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            ...
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td width="31%" align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Department Name : </td>
                                                                                    <td width="29%" align="left" valign="middle" nowrap="nowrap">
                                                                                        <html:select property="department">
                                                                                            <html:option value="">--Select--</html:option>
                                                                                            <logic:present name="deptList">
                                                                                                <html:options collection="deptList" labelProperty="departmentName" property="departmentName"/>
                                                                                            </logic:present>
                                                                                        </html:select>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Vacant Post :</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" >
                                                                                        <html:text property="post"/>
                                                                                    </td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap">&nbsp;</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Skills Required :</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" >
                                                                                        <html:text property="skillreq"/>
                                                                                    </td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap"><span class="style3">*</span>Highest Qualification :</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"> <html:text property="quali"/>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" valign="middle" nowrap>
                                                                                        <html:text property="experience"/>
                                                                                    </td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap"><span class="style3">*</span>No of Vacancies :</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="noofvac" size="4"/> </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap><span class="style3">*</span>
                                                                                        Required Before Date :
                                                                                    </td>
                                                                                    <td align="left" valign="middle" nowrap>
                                                                                        <html:text property="lastDate" readonly="true"/>
                                                                                        <html:img onclick="javascript:popUpCalendar(this,document.forms[0].lastDate,'dd/mm/yyyy')" src="images/tlsCalendarIcon.gif"  />
                                                                                    </td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap"></td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"> </td>
                                                                                </tr>
