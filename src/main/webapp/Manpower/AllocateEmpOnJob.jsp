<%-- 
    Document   : AllocateEmpOnJob
    Created on : Feb 23, 2011, 8:05:45 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="saveProjectEmp";
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="projectEmp.do">
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            <legend>Allocate Jobs to Employees</legend>
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"> <span class="style3">*</span>Allocated Employee :</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">
