<%-- 
    Document   : newjsp1
    Created on : Nov 23, 2010, 5:52:04 PM
    Author     : computer2
--%>
...
<html:html lang="true">
    <head>
        ...
        <html:base/>
        <title>Project Detail Edit</title>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        <font color="#990000" size="4">Change Project Information</font>
                                                        <html:form action="projectEdit">
                                                            <table width="80%" border="0" align="left" cellpadding="2" cellspacing="4" style="left: 446px; top: 266px; width: 606px;">

                                                                <tr>
                                                                    <td align="left" valign="middle" nowrap="nowrap">Select Project Name:</td>
                                                                    <td align="left" valign="middle" id="c"> <html:select property="id" onchange="loadData(this.form)">
