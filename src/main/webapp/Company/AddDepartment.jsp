<%-- 
    ...
    Created on : Jan 27, 2011, 7:02:33 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="addDepartment";
                  if(!checkBlank(form.companyCode,'companyCode'))
                {
                    return;
                }
                if(!checkBlank(form.departmentName,'departmentName'))
                {
                    return;
                }
                  if(!checkBlank(form.departmentCode,'departmentCode'))
                {
                    return;
                }
                 if(!checkBlank(form.departmentDescription,'departmentDescription'))
                {
                    return;
                }
                form.submit();
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <fieldset><legend>Add New Department</legend>
                                                            <html:form action="/createDepartment.do">
                                                                <table border="0" cellpadding="5" cellspacing="0" style="text-align: left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <html:select property="companyCode">
                                                                    ...
                                                                    <tr>
                                                                        <td nowrap><span class="style3">*</span>Department Name : </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td><span class="style3">*</span>Department Code :</td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td nowrap><span class="style3">*</span>
                                                                            Department Description:
                                                                        </td>
                                                                        <td>
                                                                            <html:textarea property="departmentDescription" rows="6"/>
                                                                        </td>
                                                                        <td></td>
                                                                        <td></td>
                                                                    </tr>
