<%-- 
    ...
    Created on : Feb 1, 2011, 12:46:29 PM
    Author     : Sumit Kumar
--%>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="/deptReport.do">

                                                            <font color="red" face="verdana" size="4">Department Report By Company</font>
                                                            <hr/>
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td  align="left" valign="middle">
                                                                        <html:select property="companyCode" onchange="loadReport(this.form);">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <display:table export="true" class="dataTable"  name="requestScope.deptList" style="cellpadding:5; width=600px;" sort="list"  requestURI="deptReport.do?method=deptReport"  pagesize="5"  >

                                                                            <display:column property="departmentId" title="Id" sortable="true" />
                                                                            <display:column property="departmentName" title="Department Name" sortable="true" />
                                                                            <display:column property="departmentCode" title="Department Code"   />
                                                                            <display:column property="entrydate" title="Creation Date"  />

                                                                            <display:caption style="color:red; font-size:25px;">Department Report</display:caption>
