<%-- 
    Document   : AddJobType
    Created on : Jan 29, 2011, 3:40:00 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="addJobType";
                  if(!checkBlank(form.companyCode,'companyCode'))
                {
                    return;
                }
                if(!checkBlank(form.deptId,'deptId'))
                {
                    return;
                }
                  if(!checkBlank(form.jobName,'jobName'))
                {
                    return;
                }
                form.submit();
            ...
            function loadDept(sel)
            {
                var cont=sel.value;
                var add="createJobType.do?method=loadDept&companyCode="+cont;
                ajaxpagefetcher.load("dept", add, true);
            }
        </script>
    </head>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <fieldset><legend>Add Job Type</legend>
                                                            <html:form action="/createJobType.do" >
                                                                <table border="0" cellpadding="5" cellspacing="0" style="text-align: left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <html:select property="companyCode" onchange="loadDept(this);">
                                                                    ...
                                                                    <tr>
                                                                        <td><span class="style3">*</span>Job Name:</td>
                                                                        <td>
                                                                            <html:text property="jobName"/>
                                                                        </td>
                                                                        <td></td>
                                                                        <td></td>
                                                                    </tr>
