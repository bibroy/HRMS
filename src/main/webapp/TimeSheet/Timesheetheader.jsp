...
<html:html>
    <head>
        ...
        <title>HRMS ::Time sheet header Form</title>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="saveTimesheetHeader";
              
                if(!checkBlank(form.workingdate,'workingdate'))
                {
                    return;
                }

                if(!checkBlank(form.normalduration,'normalduration'))
                {
                    return;
                }
                if(!checkBlank(form.overtimeduration,'overtimeduration'))
                {
                    return;
                }
                ...
                if(!checkBlank(form.overtimelot,'overtimelot'))

                {
                    return;
                }
                if(!checkBlank(form.overtimedesc,' overtimedesc'))
            ...
            {
                var cont=sel.value;
                var page="timesheet.do?method=getDepartment&company="+cont;
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="/timesheet" enctype="multipart/form-data">
                                                                    ...
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            ...
                                                                            <table width="80%" border="0" cellspacing="10" cellpadding="2">
                                                                                <tr>
                                                                                    <td width="31%" align="left" valign="middle" nowrap="nowrap" >Normal work duration</td>
                                                                                    <td  width="29%" align="left" valign="middle" nowrap="nowrap"><html:text property="normalduration"/></td>
                                                                                    <td width="31%" align="left" valign="middle" nowrap="nowrap" >Working Date</td>
                                                                                    <td  align="left" valign="middle" nowrap="nowrap"><html:text property="workingdate" readonly="true"/><html:img onclick="javascript:popUpCalendar(this,document.forms[0].workingdate,'dd/mm/yyyy')" src="images/tlsCalendarIcon.gif" /></td>
                                                                                </tr>
                                                                                <tr>

                                                                                   <td width="31%" align="left" valign="middle" nowrap="nowrap" >overtime slot</td>
                                                                                    <td  align="left" valign="middle" nowrap="nowrap"><html:text property="overtimelot"/></td>
                                                                                    <td  align="right" valign="middle" nowrap="nowrap" >Over Time Duration</td>
                                                                                    <td  align="left" valign="middle" nowrap="nowrap"><html:text property="overtimeduration"/></td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" valign="middle" nowrap="nowrap" id="dept">
                                                                                ...
                                                                                <tr> <td width="31%" align="left" valign="middle" nowrap="nowrap" >Overtime description</td>
                                                                                    <td  width="29%" align="left" valign="middle" nowrap="nowrap"><html:text property="overtimedesc"/></td>
                                                                                ...
                                                                                <tr>
                                                                                    <td> <html:button property="button" value="Submit"  onclick="return saveheader(this.form)" /></td>
