...
<script language="javascript" type="text/javascript">
    function increamentTxtBox(id){
        ...
        //alert(id);
        var id2=id+1;
        document.getElementById(id).innerHTML='<table  border="1" cellpadding="0" cellspacing="0" bgcolor="cornsilk"> <tr><td><b>Category Name:</b>&nbsp;&nbsp;&nbsp;</td><td> <input type="text" name="category_name"></td></tr><tr><td><b>Description:&nbsp;&nbsp;&nbsp;</b></td><td><textarea rows="1" cols="30" name="category_description"></textarea></td></tr></table><br><div id="'+id2+'"></div>';
                                                        ...
                                                        <form action="../addCategory.do" method="post">
                                                            ...
                                                            <table align="center" bgcolor="ghostwhite " width="200" >
                                                                <tr align="center" bgcolor="goldenrod">
                                                                    <td colspan="5"><font color="white"><b>Add Appraisal Category</b></font></td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center"><div id="1">
                                                                            <table  border="1" cellpadding="0" cellspacing="0" bgcolor="cornsilk" >
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><textarea rows="2" cols="30" name="category_description">
                                                                                        </textarea>  <input type="hidden" name="method" value="addCategory"/>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <br>
