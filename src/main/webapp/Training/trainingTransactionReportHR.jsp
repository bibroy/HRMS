...
<html>
    <head>
        ...
        <title>HRMS :: Training Approved by HOD</title>
                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <display:table export="true" class="dataTable"  name="requestScope.trainingTransactions" style="cellpadding:5; width=600px;" sort="list"  requestURI="../trainingTransaction.do?method=trainingTransactionList&status=hodapprove"  pagesize="10"  >

                                                                        <display:column property="trainingName" title="Training Name" sortable="true" />
                                                                        ...
                                                                        <display:caption style="color:red; font-size:25px;">Training Approved By HOD</display:caption>
