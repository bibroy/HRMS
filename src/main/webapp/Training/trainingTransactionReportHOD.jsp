<%-- 
    Document   : trainingTransactionReportHR
    Created on : Nov 18, 2010, 4:06:52 PM
    Author     : computer2
--%>
...
<html:html lang="true">
    <head>
        ...
        <title>Training Transaction Report for HR</title>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top" style="text-align: center">
                                                        <h3>Training Requests For Approval</h3>
                                                        <%--Page load here --%>
                                                            ...
                                                            <logic:present name="trainingTransactions" scope="request">
                                                                <logic:iterate id="training" name="trainingTransactions" scope="request">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <label>
                                                                                <bean:write name="training" property="empCode" />
                                                                            </label>
                                                                        </td>
                                                                        <td>
                                                                            <label>
                                                                        ...
                                                                        <td>
                                                                            <a href="../trainingApprovalHR.do?method=viewApprovedFromHR&trainingId=<bean:write name='training' property='trainingId' />&empId=<bean:write name='training' property='applyId' />&empName=<bean:write name='training' property='employeeName' />&requestId=<bean:write name='training' property='requestId' />&flg=<bean:write name='training' property='flg' />">view</a>
                                                                        </td>
                                                                    </tr>
                                                                </logic:iterate>
                                                            </logic:present>
