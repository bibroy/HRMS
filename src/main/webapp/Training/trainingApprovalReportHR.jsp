...
<html>
    <head>
        ...
        <title>HRMS :: Training Approved by HR</title>
                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <display:table export="true" class="dataTable"  name="requestScope.trainingTransactions" style="cellpadding:5; width=600px;" sort="list"  requestURI="trainingTransaction.do?method=trainingTransactionList&status=hrapprove"  pagesize="10"  >
                                                                        ...
                                                                        <display:caption style="color:red; font-size:25px;">Training Approved By HR</display:caption>
