...
<html>
    <head>
        ...
        <title>HRMS :: List of Training</title>
                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <display:table export="true" class="dataTable"  name="requestScope.trainings" style="cellpadding:5; width=600px;" sort="list"  requestURI="trainingAdd.do?method=trainingReport"  pagesize="10"  >

                                                                        <display:column property="trainingId" title="Training Id" sortable="true" />
                                                                        <display:column property="trainingType" title="Training Type"   />
                                                                        <display:column property="trainingName" title="Training Name" />
                                                                        <display:column property="trainer" title="Trainer"  />
                                                                        <display:column property="status" title="Status"/>

                                                                        <display:caption style="color:red; font-size:25px;">List Of Training</display:caption>
