<%-- 
    Document   : trainingRequestEmployee
    Created on : Nov 15, 2010, 7:29:34 PM
    Author     : computer2
--%>
...
<html:html lang="true">
    <head>
        ...
        <title>Training Request Employee</title>
        ...
        <script type="text/javascript">
            ...
            <%-- javascript add here --%>
                function addTraining(form){
                    form.method.value="addTrainingEmployee";
                ...
                function winRefreshnew(form){
                    //window.location.href="../HRMS/trainingRequestEmployee.do?method=reqFromEmploye";
                    // --window.location.href="./trainingRequestEmployee.do?method=reqFromEmploye";
                ...
                function chkAllFields(form){
                    /*
                   alert("@@Skill Type@@"+form.ddlSkillsName.selectedIndex);
                    alert("@@Training Name@@"+form.ddlTrainingName.selectedIndex);
                   alert("@@form.availableFrom@@"+form.availableTo.value);
                   alert("@@form.availableTo@@"+form.availableTo.value);
                     */
                    if(!checkOption(form.ddlSkillsName,' Skill Type')){
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" valign="middle">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <Page load here>
                                                    <html:form action="/trainingRequestEmployee" method="post">
                                                        <table  style="vertical-align:top">
                                                            ...
                                                            <tr>
                                                                <td valign="middle">JobType</td>
                                                                <td valign="middle" align="left">
                                                                    <html:text property="jobType" />
                                                                    <%--<bean:write name="TrainingTransactionForm" property="jobType"/><html:select property="jobType" onchange="return desSkills(this)" indexed="jobId" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="middle" align="left">
                                                                    ...
                                                                    <html:img onclick="javascript:popUpCalendar(this, document.forms[0].availableFrom,'dd/mm/yyyy')" src="../images/tlsCalendarIcon.gif"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="middle" nowrap="nowrap"><span class="style3">*</span>
                                                                ...
                                                                <td valign="middle" align="left">
                                                                    ...
                                                                    <html:img onclick="javascript:popUpCalendar(this, document.forms[0].availableTo,'dd/mm/yyyy')" src="../images/tlsCalendarIcon.gif"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="middle">
