...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            function RunawayInformationLoad(form){
                form.method.value="RunawayInformationRetreive";
                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <html:form action="runawayReport" method="get"  styleClass="none" styleId="empCerationForm">
                                                                        <center><font color="red" face="verdana" size="4">Runaway report of Employees</font></center>
                                                                        <hr/>
                                                                        ...
                                                                        <center> <table width="80%" border="1" cellspacing="4"   cellpadding="2" style="Background:#FFEECA" >
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="center">
                                                                                        ...
                                                                                        <display:table export="true"  class="dataTable"  name="requestScope.runawayemployees" style="cellpadding:5; width=600px;" sort="list"  requestURI="/runawayReport.do?method=RunawayInformationRetreive"  pagesize="5"  >
