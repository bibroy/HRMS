<%-- 
    Document   : employeeCreation
    Created on : Nov 18, 2010, 5:33:49 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: Create New Employee</title>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="createHr" method="post"  styleClass="none" styleId="empCerationForm">
                                                            <!--Start Main table-->
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td align="left" valign="top"><!--Start Personal Info table-->
                                                                        ...
                                                                        <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" valign="middle" nowrap="nowrap">Old Employment No.: </td>
                                                                                <td align="left" valign="middle" nowrap="nowrap">
