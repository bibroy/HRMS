                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <display:table export="true" class="dataTable"  name="sessionScope.empList" style="cellpadding:5; width=600px;" sort="list"  requestURI="/viewEmpReport.do?method=getEmployeeReport"  pagesize="10"  >
                                                                        ...
                                                                        <display:caption style="color:red; font-size:25px;">Employees BirthDay List</display:caption>
