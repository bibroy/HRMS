<%-- 
    Document   : Employee Skills add page
    Created on : 
    Author     : Pradipto Roy
--%>
...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            {
                form.method.value="EmployeeSkillEditSavepage";
...
function ipFieldValidation(form){
                ...
                if(!checkBlank(form.employeid,'employeid'))
                {
                ...
                if(!checkChar(form.skills,'skills'))
                {
                    return false;
                }
                ...
                if(!checkBlank(form.proficiency,'Branch Address'))
                {
                    return false;
                }
             ...
             function loadTask(form){
                form.method.value="EmployeeSkillretreivepage";
                alert(form.method.value);
                form.submit();
             }
                                            ...
                                            <table width="100%"  cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="employeeaddskill"   styleClass="none" styleId="empCerationForm">
                                                            <!--Start Main table-->
                                                            <table width="100%"  cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"><!--Start Personal Info table-->
                                                                        <h2>Employee Skills add page</h2>
                                                                        <table width="80%" border="0" cellspacing="4" cellpadding="4" >
                                                                            <tr><td><font color="red" size=2> Employee id:</font></td><td><font color="red" size=3><html:text property="employeid" readonly="false" /></font></td></tr>
                                                                            <tr><td>Employee Skills:</td><td><html:text property="skills" /></td></tr>


                                                                     
                                                                            <tr><td>Proficency :</td><td><html:text property="proficiency" />
