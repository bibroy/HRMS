<%--
    Document   : Organization Structure Report
    Created on : 
    Author     : Pradipto roy
--%>
...
<html>
    <head>
        ...
        <title>HRMS ::Organization Report</title>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            function OrganizationStructureLoad(form){
                form.method.value="OrganizationStructureLoadCall";
                                                        ...
                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <html:form action="OrganizationStructureReport" method="get"  styleClass="none" styleId="empCerationForm">
                                                                        <center><font color="black" face="verdana" size="4">Organization Structure Report</font></center>
                                                                        <hr/>
                                                                        <br>
                                                                        ...
                                                                        <center> <table width="80%" border="1" cellspacing="4"   cellpadding="2" style="Background:#FFEECA" >
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="center">
                                                                                        ...
                                                                                        <display:table export="true"  class="dataTable"  name="requestScope.runawayemployees" style="cellpadding:5; width=600px;" sort="list"  requestURI="/OrganizationStructureReport.do?method=OrganizationStructureLoadCall"  pagesize="5"  >
                                                                                            ...
                                                                                            <display:caption style="color:Red; font-size:15px;">Employees Information</display:caption>
