<%-- 
    Document   : ViewAllLoanApplications
    Created on : Nov 25, 2010, 11:39:21 AM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: View All Loan Applications</title>
        ...
        <script type="text/javascript">
            ...
            function approve(form,idval1)
            {
                ...
                window.location.href="LoanApproval.do?method=approveLoanRequest&hiddenId="+idval1;
            ...
            {
                window.location.href="LoanRejection.do?method=rejectLeaveRequest&hiddenId="+idval2;
                alert(" id "+idval2);
                form.submit();
            }
            ...
            function fnFurtherDetail(empId) {
                ...
                var linkPage="../EmployeeDetailsForLoan.do?method=getSingleEmployeeDetails&empId="+empId;
                //alert(linkPage);
                                                                ...
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Loan Amount </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Reason </td>

                                                                            <td width="5%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> No Of Installment</td>
                                                                            <td width="20%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Deduction Starting Month</td>
                                                                                ...
                                                                                <html:form action="ViewAllLoanApplicationDetails" >
                                                                                    <tr bgcolor="<c:if test="${no%2!=0}" >cornsilk</c:if><c:if test="${no%2==0}" >white</c:if>">
                                                                                        ...
                                                                                        <td align="center">
                                                                                            ...
                                                                                            <!--<a href="EmployeeDetailsForLoan.jsp" onclick="NewWindow(this.href,'mywin','800','600','yes','center');return false" >View Employee Details</a>-->
                                                                                        </td>
