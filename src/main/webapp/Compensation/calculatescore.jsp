<%--
    Document   : calculate score
    Created on : Feb 15, 2011, 12:11:38 PM
    Author     : pranav kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: calculate form</title>
        ...
        <script type="text/javascript">
            function calculatesummary(form){
                form.method.value="scoreCalculation";
                form.submit();
            }

            function genAward(form){
                form.method.value="genAwardLetter";
                                                                        ...
                                                                        <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                                    ...
                                                                                    <p>please press on calculate button for further process </p>
                                                                                </td></tr></table>
                                                                                <html:form action="performancesheet" method="post">
                                                                            <table>
                                                                                <tr>
                                                                                    <td> <html:button property="button" value="calculate"  onclick="return calculatesummary(this.form)" /></td>
                                                                                ...
                                                                                <tr><td>
                                                                                        <logic:present name="emp" scope="request">
                                                                                            <font  color="green">Employee:</font> <bean:write name="emp"/>
                                                                                            <input type="hidden" name="empid" value="<bean:write name="emp"/>"/>

                                                                                        </logic:present>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr><td>
                                                                                        <logic:present name="score" scope="request">
                                                                                            <font  color="green">Score:</font>  <bean:write name="score"/>
                                                                                            <input type="hidden" name="score" value="<bean:write name="score"/>"/>  
                                                                                        </logic:present>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <logic:present name="score" scope="request">
                                                                                        <html:button property="button" value="Generate Award Letter" onclick="genAward(this.form);"/>
                                                                                    </logic:present>
                                                                                </tr>
