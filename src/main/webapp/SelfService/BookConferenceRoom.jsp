<%-- 
    Document   : BookConferenceRoom
    Created on : Feb 5, 2011, 4:01:52 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: Book Conference Room</title>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="bookConferenceRoom";
                if(!checkBlank(form.employeeid,'Employee Id'))
                {
                    return;
                }
                if(!checkBlank(form.roomno,'Room No'))
                {
                    return;
                }

                if(!checkBlank(form.bookingdate,'Booking Date'))
                {
                    return;
                }
    ...
    <body background="palegoldenrod">
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
               <td width="100%" colspan="3" align="left" valign="top"><img src="images/Conference.jpg" width="100%" height="138" /></td>
            </tr>
            <tr>
                <td height="3"></td>
                <td height="3"></td>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="conferenceRoom.do">
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td align="left" valign="top"><div id="errorMsg" ></div>
                                                                        ...
                                                                        <logic:messagesPresent>
                                                                            ...
                                                                            <font color="red">  <html:messages id="booking"><bean:write name="booking"/></html:messages></font>
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            <legend>Conference Room Booking</legend>
                                                                            <br/>
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Room No : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">
                                                                                        <html:select property="roomno">
                                                                                            <html:option value="">-Select-</html:option>
                                                                                            <logic:present name="roomlist" scope="request">
                                                                                                <html:options collection="roomlist" property="roomno" labelProperty="roomno"/>
                                                                                            </logic:present>
                                                                                        </html:select>
                                                                                    </td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" >&nbsp; </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Booking Date : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="bookingdate" readonly="true" />
                                                                                         <html:img onclick="javascript:popUpCalendar(this,document.forms[0].bookingdate,'dd/mm/yyyy')" src="../images/tlsCalendarIcon.gif" />
                                                                                    </td>
                                                                                     <td align="right" valign="middle" nowrap="nowrap" >&nbsp;</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" valign="middle" nowrap="nowrap">
                                                                                         <html:select property="fromhour" value="10">
                                                                                            <c:forEach var="i" begin="1" end="24">
                                                                                                <html:option value="${i}">${i}</html:option>
                                                                                            </c:forEach>
                                                                                        </html:select>
                                                                                        <html:select property="frommin" value="0">
                                                                                    ...
                                                                                    <td align="left" valign="middle" nowrap="nowrap">
                                                                                         <html:select property="tohour" value="10">
                                                                                            <c:forEach var="i" begin="1" end="24">
                                                                                                <html:option value="${i}">${i}</html:option>
                                                                                            </c:forEach>
                                                                                        </html:select>
                                                                                        <html:select property="tomin" value="0">
                                                                                            <c:forEach var="i" begin="0" end="60" step="5">
                                                                                                <html:option value="${i}">${i}</html:option>
                                                                                            </c:forEach>
                                                                                        </html:select>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="top" nowrap="nowrap"><span class="style3">*</span>Reason : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" colspan="2">
                                                                                        <html:textarea property="reason" cols="40" rows="5"/>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
