<%-- 
    Document   : RequestForDocuments
    Created on : Feb 9, 2011, 11:44:44 AM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: Request For Documents</title>
        ...
        <script type="text/javascript">
            ...
            function sendRequest(form)
            {
                ...
                if(!checkBlank(form.documentsname,'Document Name'))
                {
                    return;
                }
                 if(!checkChar(form.documentsname,'Document Name'))
                {
                    return;
                }
                ...
                if(!checkBlank(form.reason,'Reason'))
                {
                 ...
                 if(!checkChar(form.reason,'Reason'))
                {
                    return;
                }
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            <legend>Request For Documents</legend>
                                                                            <br/>
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Document Name : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="documentsname"/></td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" >&nbsp; </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Reason : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" colspan="3"><html:textarea property="reason" cols="50" /></td>
