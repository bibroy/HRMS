<%-- 
    Document   : SelfInsuranceDetails
    Created on : Feb 15, 2011, 3:08:33 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: Employee Insurance Report</title>
                                                        ...
                                                        <table width="600" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top" width="600">
                                                                    ...
                                                                    <display:table export="true" class="dataTable"  name="requestScope.eiList" style="cellpadding:5; width=600px;" sort="list"  requestURI="addInsurance.do?method=getSelfInsuranceDetails"  pagesize="10" >

                                                                        <display:column property="id" title="Ins Reg Id" sortable="true" />
                                                                        <display:column property="employeeId" title="Employee Id" />
                                                                        <display:column property="insuranceNo" title="Ins No" />
                                                                        <display:column property="insuranceProvider" title="Ins Provider"  />
                                                                        <display:column property="premiumAmount" title="Premium Amount"/>
                                                                        <display:column property="premiumDate" title="Premium Date"/>
                                                                        <display:column property="insuredAmount" title="Insured Amount"/>
                                                                        <display:column property="maturityDate" title="Maturity Date"/>


                                                                        <display:caption style="color:red; font-size:25px;">Employee Insurance Details</display:caption>
                                                                        ...
                                                                        <display:setProperty name="pdf.export.pdf.header" value="Visa Request Details"/>
