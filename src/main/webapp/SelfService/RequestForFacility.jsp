<%-- 
    Document   : RequestForFacility
    Created on : Feb 9, 2011, 8:05:48 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: Request For Facility</title>
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            <legend>Request For Facility</legend>
                                                                            <br/>
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Facility Name : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="facilityname"/></td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" >&nbsp; </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
