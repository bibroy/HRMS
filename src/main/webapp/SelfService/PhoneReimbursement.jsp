<%-- 
    Document   : PhoneReimbursement
    Created on : Feb 15, 2011, 6:48:03 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: Request For Phone Reimbursement</title>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="sendRequest";
                if(!checkBlank(form.employeeid,'Employee Id'))
                {
                    return;
                }
                if(!checkBlank(form.phoneno,'Phone No'))
                {
                    return;
                }
                  if(!checkPhnNo(form.phoneno,'Phone No'))
                {
                    return;
                }


                if(!checkBlank(form.totalamount,'Total Amount'))
                {
                    return;
                }
                if(!checkBlank(form.phonebillid,'Phone Bill Id'))
                {
                    return
                }
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            <legend>Request For Phone Reimbursement</legend>
                                                                            <br/>
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Phone No : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="phoneno"/></td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" >&nbsp; </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Total Amount : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="totalamount" /></td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span> Phone Bill Id : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="phonebillid" /></td>
                                                                                </tr>
