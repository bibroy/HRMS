<%-- 
    Document   : ViewFacilityRequest
    Created on : Feb 12, 2011, 4:37:56 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: View Facility Requests</title>
        ...
        <script type="text/javascript">
            ...
            function facApprove(form,idval1)
            {
                ...
                window.location.href="requestFacility.do?method=approveFacility&hiddenId="+idval1;
                //form.method.value="approveLeaveRequest";    
                form.submit();
            }
            function facReject(form,idval2)
            {
                window.location.href="requestFacility.do?method=rejectFacility&hiddenId="+idval2;
                form.submit();
            }
                                                                ...
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Facility Name </td>
                                                                        ...
                                                                        <logic:present name="empList" scope="request">
                                                                            <logic:iterate id="itr" name="empList" indexId="no">
                                                                                <html:form action="requestFacility.do">
                                                                                    ...
                                                                                    <tr bgcolor="<c:if test="${no%2!=0}" >cornsilk</c:if><c:if test="${no%2==0}" >white</c:if>" align="center">
                                                                                        ...
                                                                                        <td>
                                                                                            <bean:write name="itr" property="facilityname"></bean:write>
                                                                                        </td>
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="button" value="Approve" onclick="facApprove(this.form,<bean:write name='itr' property='id'/>)"/>
                                                                                            ...
                                                                                            <div style="margin-top:5px;">
                                                                                                ...
                                                                                                <div style="margin-top:5px; display:none;">
                                                                                                    <table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <input type="button" value="Submit" onclick="facReject(this.form,<bean:write name='itr' property='id'/>)"/>
