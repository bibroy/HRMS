<%-- 
    Document   : RequestForTransport
    Created on : Feb 2, 2011, 7:23:38 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <title>HRMS :: Request For Transport</title>
        ...
        <script type="text/javascript">
            ...
            {
                form.method.value="saveTransportRequest";
                if(!checkBlank(form.employeeid,'Employee Id'))
                {
                    return;
                }
                if(!checkBlank(form.transportname,'Transport'))
                {
                    return;
                }
                if(!checkChar(form.transportname,'Transport'))
                {
                    return;
                }


                if(!checkBlank(form.transportFrom,'From'))
                {
                    return;
                }

                if(!checkBlank(form.transportTo,'To'))
                {
                    return;
                }

                if(!checkBlank(form.transportDate,'Date'))
                {
                    return;
                }
                                                            ...
                                                            <table width="761" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            <legend>Transport Request Form</legend>
                                                                            <br/>
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Transport Required : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="transportname"/></td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" >&nbsp; </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>From : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="transportFrom" /></td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" ><span class="style3">*</span>To : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="transportTo"/></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Date : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><html:text property="transportDate" readonly="true"/>
                                                                                        <html:img onclick="javascript:popUpCalendar(this,document.forms[0].transportDate,'dd/mm/yyyy')" src="../images/tlsCalendarIcon.gif" />
                                                                                    </td>
                                                                                    <td align="right" valign="middle" nowrap="nowrap" ><span class="style3">*</span>Departure Time :</td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"> 
                                                                                        <html:select property="departuretimehour" value="10">
                                                                                            <c:forEach var="i" begin="1" end="12">
                                                                                                <html:option value="${i}">${i}</html:option>
                                                                                            </c:forEach>
                                                                                        </html:select>
                                                                                        <html:select property="departuretimemin" value="0">
                                                                                            <c:forEach var="i" begin="0" end="60" step="5">
                                                                                                <html:option value="${i}">${i}</html:option>
                                                                                            </c:forEach>
                                                                                        </html:select>
                                                                                        <html:select property="departureampm">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Reason : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" colspan="3">
                                                                                        <html:textarea property="reason" cols="60"/>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
