<%-- 
    Document   : Complaints
    Created on : Feb 2, 2011, 12:27:10 PM
    Author     : Sumit Kumar
--%>
...
<html:html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function sendComplaint(form)
            {
                form.method.value="saveComplaint";
                  if(!checkBlank(form.subject,'subject'))
                {
                    return;
                }
                 if(!checkBlank(form.complaintext,'complain text'))
                {
                    return;
                }
                  if(!checkBlank(form.suggestion,'suggestions'))
                {
                    return;
                }
                form.submit();
    ...
    <body background="palegoldenrod">
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="100%" colspan="3" align="left" valign="top"><img src="../images/Complain.jpg" width="100%" height="138" /></td>
            </tr>
            <tr>
                <td height="3"></td>
                <td height="3"></td>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr style="height: 200px;">
                                                    <td align="left" valign="top">
                                                        ...
                                                        <html:form action="submitComplaint.do">
                                                                    ...
                                                                    <td class="body_mid" style="padding:0 0 0 5px;" valign="bottom">
                                                                        <fieldset>
                                                                            ...
                                                                            <table width="80%" border="0" cellspacing="4" cellpadding="2" >
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><span class="style3">*</span>Subject : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" colspan="3"><html:text property="subject" style="width:90%"/></td>
                                                                                    
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" valign="top" nowrap="nowrap"><span class="style3">*</span>Complaint : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" colspan="3"><html:textarea property="complaintext" rows="7" cols="70"/></td>
                                                                                </tr>
                                                                                
                                                                                <tr>
                                                                                    <td align="left" valign="top" nowrap="nowrap"> <span class="style3">*</span>Suggestions : </td>
                                                                                    <td align="left" valign="middle" nowrap="nowrap" colspan="3"><html:textarea property="suggestion" cols="50"/></td>
                                                                                </tr>
                                                                                    ...
                                                                                    <td align="left" valign="middle" nowrap="nowrap"><table width="30%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                <td align="right" valign="middle">
                                                                                                    ...
                                                                                                    <html:button property="button" value="Submit"  onclick="return sendComplaint(this.form)" />
                                                                                                </td>
