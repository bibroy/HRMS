<%-- 
    Document   : ViewTransportRequest
    Created on : Feb 14, 2011, 4:31:44 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: View Transport Requests</title>
        ...
        <script type="text/javascript">
            ...
            function facApprove(form,idval1)
            {

                window.location.href="transportRequest.do?method=approveTransport&hiddenId="+idval1;
                //form.method.value="approveLeaveRequest";
                form.submit();
            }
            function facReject(form,idval2)
            {
                window.location.href="transportRequest.do?method=rejectTransport&hiddenId="+idval2;
                form.submit();
            }
            ...
            function fnFurtherDetail(empId) {
                ...
                var linkPage="EmployeeDetailsForAdvancedSalary.do?method=getSingleEmployeeDetails&empId="+empId;
                //alert(linkPage);
    ...
    <body background="palegoldenrod">
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td width="100%" colspan="3" align="left" valign="top"><img src="images/Transport.jpg" width="100%" height="138" /></td>
            </tr>
            <tr>
                <td height="3"></td>
                <td height="3"></td>
                                                                ...
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Transport Name </td>
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> From </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">To </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Date </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Time </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Reason </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Request Date </td>
                                                                        ...
                                                                        <logic:present name="transList" scope="request">
                                                                            <logic:iterate id="itr" name="transList" indexId="no">
                                                                                <html:form action="transportRequest.do">
                                                                                    ...
                                                                                    <tr bgcolor="<c:if test="${no%2!=0}" >cornsilk</c:if><c:if test="${no%2==0}" >white</c:if>" align="center">
                                                                                        ...
                                                                                        <td>
                                                                                            <bean:write name="itr" property="employeeid"></bean:write>
                                                                                            <br/><a href="#" onclick="return openWindow(<bean:write name='itr' property='employeeid'/>);" >View</a>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="transportname"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="transportFrom"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="transportTo"></bean:write>
                                                                                        </td>

                                                                                        <td>
                                                                                            <bean:write name="itr" property="transportDate"></bean:write>
                                                                                        </td>
                                                                                        <td>
                                                                                            <bean:write name="itr" property="departuretime"></bean:write>
                                                                                        </td>
                                                                                        <td>
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="button" value="Approve" onclick="facApprove(this.form,<bean:write name='itr' property='requestId'/>)"/>

                                                                                        </td>
                                                                                        <td>
                                                                                            <%-- <input type="button" value="Reject" onclick="adSalReject(this.form,<bean:write name='itr' property='id'/>)"/>--%>
                                                                                            ...
                                                                                            <div style="margin-top:5px;">
                                                                                                ...
                                                                                                <div style="margin-top:5px; display:none;">
                                                                                                    <table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <input type="button" value="Submit" onclick="facReject(this.form,<bean:write name='itr' property='requestId'/>)"/>
