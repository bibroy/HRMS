<%-- 
    Document   : ViewDocumentRequest
    Created on : Feb 12, 2011, 7:24:45 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: View Document Request</title>
        ...
        <script type="text/javascript">
            ...
            function docApprove(form,idval1)
            {

                window.location.href="requestDocuments.do?method=approveDocument&hiddenId="+idval1;
                //form.method.value="approveLeaveRequest";
                form.submit();
            }
            function docReject(form,idval2)
            {
                window.location.href="requestDocuments.do?method=rejectDocument&hiddenId="+idval2;
                form.submit();
            }
                                                                ...
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Document Name </td>
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Reason </td>
                                                                        ...
                                                                        <logic:present name="docList" scope="request">
                                                                            <logic:iterate id="itr" name="docList" indexId="no">
                                                                                <html:form action="requestDocuments.do">
                                                                                    ...
                                                                                    <tr bgcolor="<c:if test="${no%2!=0}" >cornsilk</c:if><c:if test="${no%2==0}" >white</c:if>" align="center">
                                                                                        ...
                                                                                        <td>
                                                                                            <bean:write name="itr" property="documentsname"></bean:write>
                                                                                        </td>
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="button" value="Approve" onclick="docApprove(this.form,<bean:write name='itr' property='requestcode'/>)"/>
                                                                                            ...
                                                                                            <div style="margin-top:5px;">
                                                                                                ...
                                                                                                <div style="margin-top:5px; display:none;">
                                                                                                    <table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <input type="button" value="Submit" onclick="docReject(this.form,<bean:write name='itr' property='requestcode'/>)"/>
