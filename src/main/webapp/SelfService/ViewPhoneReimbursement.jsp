<%-- 
    Document   : ViewPhoneReimbursement
    Created on : Feb 16, 2011, 8:39:56 PM
    Author     : Sumit Kumar
--%>
...
<html>
    <head>
        ...
        <title>HRMS :: View Phone Reimbursement Requests</title>
        ...
        <script type="text/javascript">
            ...
            function phoneApprove(form,idval1)
            {

                //window.location.href="phoneReimbursement.do?method=approveReimbursement&hiddenId="+idval1;
                form.method.value="approveReimbursement";
                form.hiddenId.value=idval1;
                form.submit();
            }
            function phoneReject(form,idval2)
            {
                //window.location.href="phoneReimbursement.do?method=rejectReimbursement&hiddenId="+idval2;
                form.method.value="rejectReimbursement";
                form.hiddenId.value=idval2;
                form.submit();
            }
                                                                ...
                                                                <td class="body_mid" style="padding:0 0 0 5px;" valign="top">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
                                                                        <tr>
                                                                            ...
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Phone No </td>
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Total Amount </td>
                                                                            <td width="6%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg">Request Date </td>
                                                                            <td width="9%" align="center" valign="middle" bgcolor="#B27138" class="menu_bg"> Bill Id </td>
                                                                        ...
                                                                        <logic:present name="phoneList" scope="request">
                                                                            <logic:iterate id="itr" name="phoneList" indexId="no">
                                                                                <html:form action="phoneReimbursement.do">
                                                                                    ...
                                                                                    <tr bgcolor="<c:if test="${no%2!=0}" >cornsilk</c:if><c:if test="${no%2==0}" >white</c:if>" align="center">
                                                                                        ...
                                                                                        <td>
                                                                                            <bean:write name="itr" property="phoneno"></bean:write>
                                                                                        </td>
                                                                                        ...
                                                                                        <td>
                                                                                         ...
                                                                                         <td>
                                                                                            <bean:write name="itr" property="phonebillid"></bean:write>
                                                                                        </td>
                                                                                        <td>
                                                                                            <input type="button" value="Approve" onclick="phoneApprove(this.form,<bean:write name='itr' property='requestid'/>)"/>
                                                                                            ...
                                                                                            <div style="margin-top:5px;">
                                                                                                ...
                                                                                                <div style="margin-top:5px; display:none;">
                                                                                                    <table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <input type="button" value="Submit" onclick="phoneReject(this.form,<bean:write name='itr' property='requestid'/>)"/>
